...
- 2025-11-04 | Codex | Harness | DebugManualTargetSelector integra selección manual de objetivos con highlight HUD.
- 2025-11-04 | Codex | Loadouts | Prefabs heredan drop table via EnemyMetadata o el arquetipo por defecto.
